...
- (IBAction)report:(NSMenuItem *)sender {
    [[NSWorkspace sharedWorkspace] openURL:[NSURL URLWithString:@"https://github.com/minh-ton/big-hedge-patcher/issues"]];
}

- (IBAction)sourceCode:(NSMenuItem *)sender {
    [[NSWorkspace sharedWorkspace] openURL:[NSURL URLWithString:@"https://github.com/minh-ton/big-hedge-patcher"]];
}
