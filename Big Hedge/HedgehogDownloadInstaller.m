...
- (void)downloadInstaller {
    ...
    NSString *installerPKG = @"https://swcdn.apple.com/content/downloads/14/38/042-45246-A_NLFOFLCJFZ/jk992zbv98sdzz3rgc7mrccjl3l22ruk1c/InstallAssistant.pkg";
    NSURLRequest *requestDownload = [NSURLRequest requestWithURL:[NSURL URLWithString:installerPKG] cachePolicy:NSURLRequestUseProtocolCachePolicy timeoutInterval:6000.0];
